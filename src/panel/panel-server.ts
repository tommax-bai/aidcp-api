...
import type { AutomationDispatchActivity } from 'aidcp-kernel/kernel/operator-command-port.js';
...
import { RISK_ACTIONS, type RiskSignalKind, type RiskQuotaLevel } from 'aidcp-kernel/kernel/risk-contract.js';
...
import { isCuratedContentUnavailableError } from 'aidcp-kernel/kernel/curated-content-types.js';
