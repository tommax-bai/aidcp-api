...
import type { EventFanoutPort, PanelEventHandler } from 'aidcp-kernel/kernel/event-fanout-port.js';
import type { PanelEventDelivery, PanelEventDeliveryPort } from 'aidcp-kernel/kernel/panel-event-delivery-port.js';
