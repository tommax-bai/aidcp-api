...
import type { AccountPauseState } from 'aidcp-kernel/kernel/account-pause-port.js';
 ...
 */
export type { AccountPauseState } from 'aidcp-kernel/kernel/account-pause-port.js';
