 ...
 */
export type { PlatformActionHalt } from 'aidcp-kernel/kernel/config-mirror-bump-types.js';
import type { PlatformActionHalt } from 'aidcp-kernel/kernel/config-mirror-bump-types.js';
...
} from 'aidcp-kernel/kernel/transport-gate-exemptions.js';
