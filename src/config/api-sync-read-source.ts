...
import { resolveHotLeadGateConfig } from 'aidcp-kernel/kernel/hot-lead-gate-config.js';
import {
  coerceFacebookCommentMode,
  facebookCommentModeToWire,
} from 'aidcp-kernel/kernel/facebook-comment-config-types.js';
import type { FacebookOperationPolicyBaseProjection } from 'aidcp-kernel/kernel/facebook-operation-policy-resolution.js';
